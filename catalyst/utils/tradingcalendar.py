...
# compatibility.  Look at the `catalyst.utils.calendars.trading_schedule`
# module, as well as the calendar definitions in `catalyst.utils.calendars`.
...
#     "`catalyst.utils.calendars.trading_schedule` module,  as well as the "
#     "calendar definitions in `catalyst.utils.calendars`.",
